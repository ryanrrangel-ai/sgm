...
if (!$id_ambiente || !$id_tipo || empty($descricao)) {
    ...
    false, "message" => "Preencha todos os campos obrigatórios."]);
    exit;
}
$sql = "INSERT INTO chamados 
(descricao_problema, id_solicitante, id_ambiente, id_tipo_servico, status) 
...
if ($conn->query($sql)) {
    ...
    echo json_encode(["success" => 
    true, "message" => "Chamado #$id_chamado aberto com sucesso!"]);
} else {
    echo json_encode(["success" => 
